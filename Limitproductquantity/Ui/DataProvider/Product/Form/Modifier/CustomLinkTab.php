...
namespace Magecurious\Limitproductquantity\Ui\DataProvider\Product\Form\Modifier;
...
class CustomLinkTab extends AbstractModifier
{
    ...
    {
        $content = __(
            'Complementery products are shown to customers as addons to the item the customer is looking at.'
        );
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'label' => __('Add Complementery Products'),
                        'collapsible' => false,
                        'componentType' => Fieldset::NAME,
                        'dataScope' => '',
                        'sortOrder' => 10,
